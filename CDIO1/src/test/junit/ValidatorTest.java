 ...
 */
	...
	public void testValidateUsername() {
		...
		try {
			...
			fail("User name: '"+ userName+ "' of length:"+userName.length()+ " was not a valid username, but it should be.");
		}
 ...
 */
	...
	public void testValidateInitials() {
		...
		try {
			...
			fail("Initals: '"+ ini+ "' of length:"+ini.length()+ " was not a valid set of initals, but it should be.");
		}
		
		try {
			ini="rgwsr";
			Validator.validateInitials(ini);
			fail("Initals: '"+ ini+ "' of length:"+ini.length()+ " was a valid set of initals, but it shouldn't be.");
		} catch (InputException e) {
