...
/**
 * The class UserCreator extends the class TUI. The responsibility of this class
 * is to carry out the tasks of creating a new user and add it to the data.
 * 
 * @author Group 22
 *
 */
public class UserCreator extends TUI {
	...
	/**
	 * Creates a new user (UserDTO) by asking the user administrator for the
	 * information required and generates the rest.
	 */
	...
	/**
	 * Asks the user administrator which userID should be assigned to the new
	 * user (UserDTO).
	 */
	...
	/**
	 * Asks the user administrator which username should be assigned to the new
	 * user (UserDTO)
	 */
	...
	/**
	 * Asks the user administrator which CPR should be assigned to the new user
	 * (UserDTO).
	 */
	private void getCpr() {
	...
	/**
	 * Asks the user administrator which roles should be assigned to the new
	 * user (UserDTO).
	 */
