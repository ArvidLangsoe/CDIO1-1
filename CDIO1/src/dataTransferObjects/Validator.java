 ...
 * The class also contains the inner class InputException which is an exception class. The exception 
 * is thrown if the user input something wrong.
 * @author Group 22
 *
 */
public class Validator {
	...
	/**
	 * Checks if the given userID has the valid size. It does not check if it is in the database.
	 * @param userID The userID to be checked.
	 * @return True if the userID is valid, throws InputException otherwise.
	 * @throws InputException The exception to be thrown if the given userID is not valid.
	 */
	 ...
	 * @throws InputException The exception to be thrown if the given username is not valid.
	 */
	public static boolean validateUsername(String username) throws InputException {
		// TODO overflødig kode? det andet if checker jo netop dette??
		if (username==null)
		{
	 ...
	 * @param ini The initials to be checked.
	 * @return True if the initials are valid, throws InputException otherwise.
	 * @throws InputException The exception to be thrown if the given initials is not valid.
	 */
	 ...
	 * @param cpr The CPR to be checked.
	 * @return True if the CPR is valid, throws InputException otherwise.
	 * @throws InputException The exception to be thrown if the given CPR is not valid.
	 */
	...
	/**
	 * Checks if the given password is valid. A password is valid if it follows the requirements that DTU has set.
	 * @param password The password to be checked.
	 * @return True if the password is valid, throws InputException otherwise.
	 * @throws InputException The exception to be thrown if the given password is not valid.
	 */
	 ...
	 * @throws InputException The exception to be thrown if the given role is not valid.
	 */
	public static boolean validateRole(String role) throws InputException {
		// TODO Overflødig kode igen?
		if (role==null)
		{
	...
	/**
	 * The InputException class is an exception inner class used in the Validator class.
	 * The exception is thrown if the user inputs something other than told.
	 * @author Group 22
	 *
	 */
