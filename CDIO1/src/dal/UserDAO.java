...
public class UserDAO implements IUserDAO {
	...
	/**
	 * Constructor. Constructs a user Data Access object which contains a single user, the super admin.
	 */
	public UserDAO()
	{
	...
	/**
	 * Returns the user with the specified id if he exists, throws DALException otherwise.
	 ...
	 * You cannot delete the System Admin.
